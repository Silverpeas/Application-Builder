...
public class ApplicationBuilderItem {
	...
	/**
	 * The name of the item. It can be the name of a file or the name of an archive
	 * entry.
	 * @since 1.0
	 */
	...
	/**
	 * The location of the item in an archive. examples : "library" for JAR libraries,
	 * "WEB-INF" for a descriptor.
	 * @since 1.0
	 */
	...
	/**
	 * A convenience attribute built as needed from attributes "location" and "name".
	 * The path to the item in an archive
	 * @since 1.0
	 */
